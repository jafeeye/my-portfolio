...
![image.png](content/post/proj/radius/image.png)
※有時候VMware Workstation 端口轉發會失敗，重新啟動服務
## 設定802.1X Wireless AP及VPN

![image.png](content/post/proj/radius/image1.png)
...
![image.png](content/post/proj/radius/image2.png)
...
![image.png](content/post/proj/radius/image3.png)
...
![image.png](content/post/proj/radius/image4.png)
## 設定連線

1.802.1X Wireless AP
![image.png](content/post/proj/radius/image5.png)

2.VPN連線 
![image.png](content/post/proj/radius/image6.png)